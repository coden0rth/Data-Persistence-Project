...
public class MainManager : MonoBehaviour
{
    ...
    void Start()
    {
        SetScoreText(DataManager.Instance.playerName, DataManager.Instance.playerScore);
    ...
    private void SetScoreText(string player, int score)
    {
    ...
    public void GameOver()
    {
        ...
        {
            SetScoreText(DataManager.Instance.currentPlayer, m_Points);
